      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 flex flex-col min-h-0">
        <ScrollArea className="flex-1">
          <div className="p-6 space-y-6">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select
                      ...
                      value={field.value || NO_SEG_VALUE}
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue placeholder="Select SEG (if applicable)" />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
            ...
            />
            {(watchedAgent === 'Specific Chemical' ||
              watchedAgent === 'Other') && (
              <FormField
                control={form.control}
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        type="number"
                        step="any"
                        placeholder="Occupational Exposure Limit"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} value={field.value}>
                    ...
                    <SelectContent>
                      {(
                        ['Personal', 'Area', 'Source'] as IndustrialHygieneSample['sampleType'][]
                      ).map((type) => (
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="e.g., Workshop Bay 3, Assembly Line Alpha"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Any relevant details about the sampling conditions, equipment used, etc."
                      rows={3}
                      {...field}
                    />
                  </FormControl>
